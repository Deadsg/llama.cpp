# Deadsg's Bat_llama windows guide.

using W64devkit cd to the llama.cpp folder
use mkdir build; cd build; make to build the file after you git clone llama's of your choice into this repository
